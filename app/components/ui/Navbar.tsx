...
export const Navbar = () => {
  ...
  return (
    ...
    backdrop-blur-md dark:bg-background border-b border-gray-200 
    dark:border-gray-800 font-graphik">
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <Link
              ...
              border-transparent text-md rounded-md text-gray-800 
              bg-primary-900 hover:bg-primary-600  
              transition-colors"
            >
              Sign Up
            </Link>
        ...
        <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white dark:bg-black border-b border-gray-200 dark:border-gray-800">
          ...
          <div className="pt-4 pb-3 border-t border-gray-200 dark:border-gray-800">
            <div className="flex items-center px-3 space-x-4">
              ...
              <Link
                href="/sign-up"
                className="block px-4 py-2 text-sm font-medium text-white bg-black rounded-md hover:bg-gray-800 dark:bg-white dark:text-black dark:hover:bg-gray-200"
              >
                Sign Up
              </Link>
            </div>
